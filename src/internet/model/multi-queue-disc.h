...
#ifndef MULTI_QUEUE_DISC_H
#define MULTI_QUEUE_DISC_H
 ...
 */
class MultiQueueDisc : public QueueDisc
{
public:
  /**
  ...
  /**
   * \brief MultiQueueDisc Constructor
   *
   * Create a Multi RED queue disc
   */
  MultiQueueDisc ();
